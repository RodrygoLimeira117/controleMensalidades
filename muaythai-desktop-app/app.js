    ...
    const { value: dados } = await Swal.fire({
        ...
        html: `
            <div class="swal-form-editar text-start">
                ...
                <input id="swalDataNascimento" type="date" class="form-control mb-3" value="${aluno.dataNascimento || ''}">
        ...
        preConfirm: () => {
            ...
            const dataNascimento = document.getElementById('swalDataNascimento').value || null;
            ...
            return { nomeCompleto, celularPuro, idade, diaVencimento, dataNascimento, tipoMatricula };
        }
    });
