    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Endpoint de health check (usado pelo Docker/orquestrador para saber se a API está de pé)
                        .requestMatchers("/actuator/health", "/actuator/health/**").permitAll()
                        // Swagger/OpenAPI: a página em si e a spec JSON/YAML ficam públicas (é só
                        // documentação). Os endpoints reais continuam exigindo o token normalmente -
                        // o Swagger só facilita mandar o header Authorization pela UI.
                        .requestMatchers(
                                "/swagger-ui.html",
                                "/swagger-ui/**",
                                "/v3/api-docs",
